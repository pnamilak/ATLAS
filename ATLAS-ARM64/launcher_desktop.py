...
APP_TITLE = "ATLAS - AWS Trusted Login & Access Service"
...
# --------------------------------------------------------------------------------------
def get_app_data_dir(app_name: str = "ATLAS") -> Path:
    if os.name == "nt":
...
FALLBACK_LOG = Path(os.environ.get("TMPDIR", str(Path.home()))) / "ATLAS_launcher_fallback.log"
